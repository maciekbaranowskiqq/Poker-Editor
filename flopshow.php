...
<body>
	...
	<div id="content">
			<h1 align="center"> Flop List </h1><br />
			<?php	require_once('db.php');
				$query1 = "SELECT * FROM flop
						ORDER BY idflop ASC, movenumber ASC";
			...
			"<a href='deleteflop.php?del=$row[idfloptemp]' class='buttons'>delete</a>";
