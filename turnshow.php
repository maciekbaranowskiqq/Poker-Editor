...
<body>
	...
	<div id="content">
			<h1 align="center"> Turn List </h1><br />
			<?php	require_once('db.php');
				$query1 = "SELECT * FROM turn
						ORDER BY idturn ASC, movenumber ASC";
			...
			"<a href='deleteturn.php?del=$row[idturntemp]' class='buttons'>delete</a>";
