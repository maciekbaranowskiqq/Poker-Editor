<?php require_once('db.php');
	...
	if( isset($_POST['idturn']) && ($_POST['movenumber']) && ($_POST['bigblindmove']) && ($_POST['valueone']) && ($_POST['dealermove']) 
		&& ($_POST['valuetwo']) )
	{
		$idturn = $_POST['idturn'];
		...
		$query = "INSERT INTO turn VALUES('', '$idturn', '$movenumber','$bigblindmove', '$valueone', '$dealermove', '$valuetwo')";
...
<body>
	...
	<div id="container">
		...
		<div id="content">
	<?php
	if( isset($_POST['idturn']) && ($_POST['movenumber']) && ($_POST['bigblindmove']) && ($_POST['valueone']) && ($_POST['dealermove']) && ($_POST['valuetwo']) )
	{
		if($response)
	...
	?>
		...
		<form action="turnadd.php" method="POST">
		Turn ID: <input type="text" name="idturn" value="0"><br />
