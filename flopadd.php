<?php require_once('db.php');
	...
	if( isset($_POST['idflop']) && ($_POST['movenumber']) && ($_POST['bigblindmove']) && ($_POST['valueone']) && ($_POST['dealermove']) 
		&& ($_POST['valuetwo']) )
	{
		$idflop = $_POST['idflop'];
		...
		$query = "INSERT INTO flop VALUES('', '$idflop', '$movenumber','$bigblindmove', '$valueone', '$dealermove', '$valuetwo')";
...
<body>
	...
	<div id="container">
		...
		<div id="content">
	<?php
	if( isset($_POST['idflop']) && ($_POST['movenumber']) && ($_POST['bigblindmove']) && ($_POST['valueone']) && ($_POST['dealermove']) && ($_POST['valuetwo']) )
	{
		if($response)
	...
	?>
		...
		<form action="flopadd.php" method="POST">
		Flop ID: <input type="text" name="idflop" value="0"><br />
